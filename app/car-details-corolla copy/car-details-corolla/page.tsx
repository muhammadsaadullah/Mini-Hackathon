    ...
    return(
        <div className="flex flex-col w-3/4 justify-self-center items-center bg-sky-[80px]">
            <div className="flex p-5">
                <h1 className="font-bold text-3xl"><u>Toyota Corolla 2024 Price in Pakistan, Images, Reviews & Specs</u></h1>
            </div>
            ...
            <div className="m-2">
                <button className="p-5 pt-2 pb-2 border-2 border-blue-800 bg-blue-800 rounded-md text-white">Make Payment</button>
            </div>
        </div>
    )
}